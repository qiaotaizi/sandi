...
var MathUtils = /** @class */ (function () {
     ...
     * @param m
     */
    MathUtils.euclideanModulo = function (n, m) {
        return ((n % m) + m) % m;
    };
    /**
     * 线性映射
     ...
     * @param high
     */
    MathUtils.randInt = function (low, high) {
     ...
     * @param high
     */
    MathUtils.randFloat = function (low, high) {
     ...
     * @param range
     */
    MathUtils.randFloatSpread = function (range) {
     ...
     * @param value
     */
    MathUtils.ceilPowerOfTwo = function (value) {
     ...
     * @param value
     */
    MathUtils.floorPowerOfTwo = function (value) {
